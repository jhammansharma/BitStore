...
<body class="container" style="margin:0; width:99.9%;" >
	...
	<div class="well" id="divElement">
		<fieldset>
			<legend>Distributor Login Panel</legend>
		        ...
		        <div class="container">
			        ...
			        <div class="nav-collapse collapse">
			            <ul class="nav nav-pills pull-right">
					      <li><a href="<?php echo DHS_ROOT;?>distributor/index.php?view=distributor_registration">Profile</a></li>
					     
					      <li>
					        <a href="<?php echo DHS_ROOT;?>distributor/index.php?view=stores_list">View Stores</a>
					      </li>
			...
			<div class="span8">
				<?php
				  ...
				  <?php if($view=="index" || empty($view)){?>
				  	<?php require_once "stores_list.php"; ?>
				<?php }?>
			</div>
			<div class="span2">&nbsp;</div>
		</div>
